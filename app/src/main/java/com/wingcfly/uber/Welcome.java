...
public class Welcome extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private MaterialAnimatedSwitch mWorkingSwitch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWorkingSwitch = (MaterialAnimatedSwitch) findViewById(R.id.location_switch);
...
//                    currentUserLocation.remove();
        ...
        mLogout = (Button) findViewById(R.id.btnSignOut);
            ...
            public void onClick(View v) {
                switch(status){
                    case 1:
                        ...
                        mRideStatus.setText("Chuyến đi đã hoàn thành");
    ...
    private void endRide(){
        mRideStatus.setText("Đã đón khách");
        erasePolylines();
...
//                    final double longt = lastLocation.getLongitude();
//
//                    //Update to Firebase
